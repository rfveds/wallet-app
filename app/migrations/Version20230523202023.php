 ...
 */
final class Version20230523202023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE operations (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, wallet_id INT DEFAULT NULL, title VARCHAR(45) NOT NULL, amount NUMERIC(16, 2) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_2814534812469DE2 (category_id), INDEX IDX_28145348712520F3 (wallet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE wallet (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(32) NOT NULL, balance NUMERIC(16, 2) NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
